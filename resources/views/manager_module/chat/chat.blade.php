                ...
                <div class="col-12 col-xl-8 border rounded border-success pt-2">
                  <div class="bg-success rounded text-white pt-3 text-right pr-4" style="margin-bottom: 20px">
                    <label id="clientNameLabel" value="1" for="">{{$client_name}}</label>
                          ...
                          <div id="msgBoxSection" style="height:270px; overflow:auto; padding:0px 15px 0px 15px">
                            @foreach($chat as $chat_single)
                            @if($chat_single['sent_from']=='Manager')
                            <br><br><span id="rcorners3" class="float-right" for="" >{{$chat_single['body']}}</span>
                            @endif
                            @if($chat_single['sent_from']=='Client')
                            <br><br><span id="rcorners4" for="" class="float-left">{{$chat_single['body']}}</span>
                            @endif
                            @endforeach
                          </div>
                        
                  <br><textarea id="textMsg" class="form-control mb-2" name="" id="" cols="90" style="height:40px; background:#f8f8f8;" placeholder="Send Message..."></textarea>
